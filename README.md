...
- **Sons de interface** sintetizados na hora (Web Audio, **sem arquivos**): bip ao selecionar, estalo Geiger nos radioativos, cliques nos botões. Botão **♪ SOM** liga/desliga.
